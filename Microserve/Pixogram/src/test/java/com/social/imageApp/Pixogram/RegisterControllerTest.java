...
public class RegisterControllerTest {
	...
	public void registerUser() throws Exception
	{
		...
		mockUser.setUsername("Akshat Bhalotia");
		mockUser.setFirstName("Akshat");
		mockUser.setLastName("Bhalotia");
		mockUser.setEmail("akshat@gmail.com");
		mockUser.setPassword("Akshat");
		mockUser.setProfilePicture("image");
		mockUser.setAbout("Akshat");
	...
	public void checkUsername() throws Exception
	{
		...
		mockUser1.setUsername("Akshat Bhalotia");
		mockUser1.setFirstName("Akshat");
		mockUser1.setLastName("Bhalotia");
		mockUser1.setEmail("akshat@gmail.com");
		mockUser1.setPassword("Akshat");
		mockUser1.setProfilePicture("image");
		mockUser1.setAbout("Akshat");
